...
# %% latent space
print('latent space')
latent_img = model.encoder(images.to("mps"))
latent_img = latent_img.view(-1, 1, 8, 16)
show_image(torchvision.utils.make_grid(latent_img.to("cpu")))
#%%
print('reconstructed')
image_recons = model(images.to("mps"))
show_image(torchvision.utils.make_grid(image_recons.to("cpu")))
...
compression_rate
#%% save model
torch.save(model.state_dict(), 'model_state_dict_1024.pth')
# %%
